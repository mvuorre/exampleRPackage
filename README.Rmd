...
output:
  github_document:
    toc: true
    toc_depth: 2
bibliography: ~/Documents/active/exampleDataPackage/README-references.bib
---
...
5. Document data analysis as package vignette
    - Creates a readable .html file showing how the data is (or could be) analyzed
6. Create a website for the data package
